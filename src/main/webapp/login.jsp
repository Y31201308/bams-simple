...
<form method="post" name="loginform" action="<%=path %>/login.do">
...
<tr height="73">
	...
	<td width="320" valign="top" background="images/6.png" rowspan="2" style="background-color: #ffffff;background-repeat: no-repeat;background-position: right bottom;">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" height="200" style="padding-left: 18px">
		<tr>
...
<table>
<tr>
<td style="color:#ffffff;font-size: 12px;" align="center">版权所有: 品互网络 Pinhuba (c)2008-2014</td>
</tr>
<tr>
<td style="color:#ffffff;font-size: 12px;" align="center">网址：<a href="http://www.pinhuba.com">http://www.pinhuba.com</a></td>
</tr>
</table>
</center>
<script type="text/javascript">
