...
function dblCallback(obj){
	var box = new Sys.msgbox('明细查看','<%=contextPath%>/bams/hrm/employee_detail.jsp?employeepk='+obj.value,'800','500');
...
function delok(id){
	...
	openMDITab("<%=contextPath%>/bams/hrm/employee_post_set.jsp?employeepks="+recordsPks+"&tab="+getMDITab());
}
...
<td id="split_l">
	...
	<div class="div_content_bottom" style="height:300px;">
		<iframe frameborder="0" src="<%=request.getContextPath() %>/bams/hrm/postset_tree.jsp" height="100%" scrolling="no" marginheight="0" width="100%"></iframe>
	</div>
</td>
<td>
<%
