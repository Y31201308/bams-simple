...
function dblCallback(obj){
	var box = new Sys.msgbox('明细查看','<%=contextPath%>/bams/hrm/post_detail.jsp?pid='+obj.value,'700','450');
		box.msgtitle="<b>查看岗位信息明细</b>";
		box.show();
}

function edit(id){
	openMDITab("<%=contextPath%>/bams/hrm/post_add.jsp?pid="+id+"&tab="+getMDITab());
}
...
function set(id){
	var box = new Sys.msgbox('岗位负责人设置',"<%=contextPath%>/bams/select_takepage/select_empbypostid.jsp?postid="+id+"&textid=tmptxt",'700','450');
