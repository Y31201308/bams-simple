...
function sendsms(){
	Sys.close();
	window.parent.mainframe.location ="<%=contextPath%>/bams/personal_work/online_sms_send.jsp?employeepk='<%=employeepk%>'";
}
...
function sendEmail(){
	Sys.close();
	window.parent.mainframe.location ="<%=contextPath%>/bams/personal_work/online_email_send.jsp?employeepk='<%=employeepk%>'";
}
