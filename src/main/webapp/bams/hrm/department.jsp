...
function dblCallback(obj){
	var box = new Sys.msgbox('明细查看','<%=contextPath%>/bams/hrm/department_detail.jsp?depid='+obj.value,'750','450');
...
function edit(id){
   openMDITab("<%=contextPath%>/bams/hrm/department_add.jsp?departmentpk="+id+"&tab="+getMDITab());
}
...
function set(id){
	var box = new Sys.msgbox('负责人设置',"<%=contextPath%>/bams/select_takepage/select_empbydeptid.jsp?deptid="+id+"&textid=tmptxt",'700','450');
