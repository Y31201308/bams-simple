...
<%@page import="com.pinhuba.core.service.SysProcessService"%>
<%
...
if(methodcode == null||methodcode.length()==0){
	...
	SysProcessService sysProcessService =(SysProcessService) webAppContext.getBean("sysProcessService");
	...
	if(methodlist!=null&& methodlist.size()>0){
		...
		for(int i=0;i<methodlist.size();i++){
			...
			if(row>0){
				tmp ="src=\""+request.getContextPath()+"/bams/tree/methodinfo_tree.jsp?code="+md.getPrimaryKey()+"&treetype="+treetype+"\"";
			}
			//输出树节点
