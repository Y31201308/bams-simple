...
<html>
	...
	<body>
		<div class="div_tree">
			...
			var tree = new WebFXLoadTree("<%=method.getMethodInfoName()%>","<%=contextPath%>/bams/tree/usermethods.jsp?code=<%=method.getPrimaryKey()%>" ,action,"","<%=contextPath%>/images/projectimg/<%=method.getImageSrc()%>");
