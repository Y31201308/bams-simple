...
function dblCallback(obj){
	var box = new Sys.msgbox('明细查看','<%=contextPath%>/bams/system_set/sys_exception_detail.jsp?aid='+obj.value,'750','550');
...
function edit(id){
    openMDITab("<%=contextPath%>/bams/system_set/sys_exception_edit.jsp?sysExceptionPk="+id+"&tab="+getMDITab());
}
function del(pk){
