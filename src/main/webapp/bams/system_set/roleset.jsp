...
function dblCallback(obj){
	var box = new Sys.msgbox("角色明细",'<%=contextPath %>/bams/system_set/roleset_detail.jsp?rid='+obj.value,'850','500');
...
function edit(id){
	var url = "<%=contextPath%>/bams/system_set/roleset_add.jsp?rid="+id;
	url += "&tab="+getMDITab();
	openMDITab(url);
}
