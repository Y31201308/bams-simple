...
loadarray[0] = "<%=contextPath %>/bams/system_set/user_manger_add.jsp";
loadarray[1] = "<%=contextPath %>/bams/system_set/user_manger_batchadd.jsp";
loadarray[2] = "<%=contextPath %>/bams/system_set/user_manger_setisation.jsp";
