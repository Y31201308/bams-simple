...
function dblCallback(obj){
	var box = new Sys.msgbox('用户编组明细查看','<%=contextPath %>/bams/system_set/user_group_detail.jsp?gid='+obj.value + '&noid=1', '800', '500');
...
function create(){
	openMDITab("<%=contextPath%>/bams/system_set/user_group_add.jsp?tab="+getMDITab());
}

function edit(id){
	openMDITab("<%=contextPath%>/bams/system_set/user_group_add.jsp?gid="+id+"&tab="+getMDITab());
}
...
btnList.add(new SysGridBtnBean("创建编组","create()","add.png"));
