...
<%
//从配置文件加载初始密码及密码长度限制
String initpwd = UtilTool.getSysParamByIndex(request,"bams.user.initPwd");
int pwdlen = Integer.parseInt(UtilTool.getSysParamByIndex(request,"bams.user.PwdLen"));
%>
...
<body class="inputcls">
	...
	<input type="hidden" id="employeeid"><input type="checkbox" id="empchk" class="nonice" style="display:none;">
	</td>
	<td align="left">
