...
function dblCallback(obj){
	var box = new Sys.msgbox('功能目录明细查看','<%=contextPath%>/bams/system_set/sys_method_detail.jsp?gid='+obj.value,'750','550');
	box.msgtitle="功能明细查看";
	box.show();
}
...
function add(){
	openMDITab("<%=contextPath%>/bams/system_set/sys_method_add.jsp?tab="+getMDITab());
}

function edit(pk){
	openMDITab("<%=contextPath%>/bams/system_set/sys_method_edit.jsp?sid="+pk+"&tab="+getMDITab());
}
