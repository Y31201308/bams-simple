...
function add(){
	openMDITab("<%=contextPath%>/bams/system_set/parammanger_add.jsp?tab="+getMDITab());
}
function edit(id){
	openMDITab("<%=contextPath%>/bams/system_set/parammanger_add.jsp?pid="+id+"&tab="+getMDITab());
}
...
<body>
<%
SysGrid grid = new SysGrid(request,"运行参数列表");
