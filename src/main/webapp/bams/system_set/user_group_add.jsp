...
String helpTitle = "您可以在此处添加您想新增的用户组！";
String isedit = "false";
if(gid!=null){//编辑时使用
	isedit = "true";
	saveOrEdit = "编辑";
    helpTitle = "您可以在此处编辑用户组！";
}
 %>
...
<input type="hidden" id="userid">
	...
	<div class="formTitle"><%=saveOrEdit %>用户编组</div>
...
function methodcallback(data){
	...
	if(<%=isedit%>){
	    ...
	    if(data.success){
	    	confirmmsgAndTitle("添加用户组成功！是否想继续添加？","reset();","继续添加","closePage();","关闭页面");
		}else{
			alertmsg(data);
		}
	}
