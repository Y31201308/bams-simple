...
public class CreatePage {
	...
	public CreatePage(String pojoClass, String pojoShortName, String pojoName, String dwrName, String columnCount, String folderName, CodeConfig config) throws ClassNotFoundException {
		...
		this.pagePath = config.getPagePath();
	...
	private String getManagePageString() throws ClassNotFoundException {
		...
		sb.append("    var box = new Sys.msgbox(\"明细查看\",\"<%=contextPath%>/bams/" + folderName + "/" + pojoShortName + "_detail.jsp?pk=\"+obj.value);\n");
		sb.append("    box.show();\n");
		sb.append("}\n");

		sb.append("function edit(pk){\n");
		sb.append("    openMDITab(\"<%=contextPath%>/bams/" + folderName + "/" + pojoShortName + "_add.jsp?pk=\"+pk+\"&tab=\"+getMDITab());\n");
		sb.append("}\n");
		...
		sb.append("    openMDITab(\"<%=contextPath%>/bams/" + folderName + "/" + pojoShortName + "_add.jsp?tab=\"+getMDITab());\n");
		sb.append("}\n");
